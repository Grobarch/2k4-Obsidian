<%*
// ============================================================
// Utwórz Lokację — skrypt Templater
...
function cancel(msg) {
  new Notice(msg || "Anulowano tworzenie lokacji.");
...
// ============================================================
// 1. Nazwa lokacji (wymagana)
// ============================================================
const name = await tp.system.prompt("Nazwa lokacji");
...
fmLines.push(`tags: [lokacja, ${systemId}]`);
